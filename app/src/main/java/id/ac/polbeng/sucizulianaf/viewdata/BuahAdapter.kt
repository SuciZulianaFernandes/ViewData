...
import id.ac.polbeng.sucizulianaf.viewdata.DetailBuahActivity
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import id.ac.polbeng.sucizulianaf.viewdata.databinding.ListItemBinding
...
class BuahAdapter(
    ...
    override fun onBindViewHolder(holder: BuahHolder, position: Int) { //manggil dan set data
